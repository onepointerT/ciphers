...
typedef struct _onepointer_ringbuffer {
    word_t** words;
    size_t ringsize;
    size_t wordlen;
    bool shifted;
...
bool onepointer_ringbuffer_rotate_symetrically( _word_ringbuf_t* wrb, const size_t startpos, const size_t neighbour_count, const bool startpos_skipped );
bool onepointer_ringbuffer_rotate_asymetrically( _word_ringbuf_t* wrb, const size_t startpos, const size_t neighbour_count
                                               , const bool starting_outside, const bool startpos_skipped
);
